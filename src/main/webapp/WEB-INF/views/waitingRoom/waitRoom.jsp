...
<script type="text/javascript">
	...
	function onMessage(event){//메시지가 왔을 때 호출될 메소드(텍스트를 json 형식으로 바꾸기) 
		...
		}else if(js.what == 'match'){
			js.homeUser
			$('#listViewArea3').empty();
			$('#listViewArea3').append(js.homeUser+"로 부터 <"+js.c_id+">게임 초대<p>");
			$('#listViewArea3').append("수락하시겠습니까 ?");
		}
...
<div>
	<div align="left" style="float: left; margin-left: 3em; overflow-y:auto; overflow-x:hidden; height:450px;">
		<h1>접속자 명단 뜰곳</h1>
